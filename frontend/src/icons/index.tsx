...
/**
 * Flame icon - app branding / burn action
 */
...
/**
 * Shield check icon - verified security
 */
...
/**
 * Double check icon - delivered/read
 */
...
/**
 * Fingerprint icon - visual verification
 */
 ...
 */
export function SuccessIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
 ...
 */
export function ErrorIcon({ size = 24, ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
/**
 * Refresh / reload icon (circular arrows)
 */
...
/**
 * Sparkles / wand icon — generate / magic action
 */
