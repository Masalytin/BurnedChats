...
Source: [`deployments/testnet.json`](deployments/testnet.json) (deployed 2026-06-25).

| Key | Address |
|-----|---------|
| jettonMaster | `kQARGlQabCFsStDFmN8gAO1I2Ufm26ZTqdDPN-mz4z3Ic66l` |
| treasury | `kQARGEKOTdNTSUBr-KXL3S1i5Auzr9DA91aBTZCCSJ5TqPJ6` |
| treasuryJettonWallet | `kQBQKZxdALLiodVA8YgYh7MfMUGcCc9Kh3tXF1-4qCic6Gz0` |
| stakingPool | `kQDDlNtd1g0LIkN59Khr1lyFTMZQ3SI3FbOLKBYkj8wKAibB` |
| stakingLock | `kQDgf2iGPl302c7AhDYZ7NLeAosohAY83EX4l_0wX_8FYF7V` |
| stakingMaster | `kQCLxNu2uoLHKd8nmjMKVDDYrlAgxUzDnitZL_sACNxxP3XW` |
| governor | `kQDPToghVzb_Dv0bEPcLHgxbmz0pSYPoDulSW4cEI12qfSNA` |
| timelock | `kQCmiWBVxfO7tpfkJkMTqwoTcmgPvKcu4jw_HyjrW034QwM6` |
| vestingDeveloper | `kQDLqvAftbLNa-C_O01uI0aBDl2ClnX3C43P3AwDpg32wLEf` |
| vestingEcosystem | `kQBR385wr3DDcxhICFd1qEXDuc29loBaDri2Gjk08fy69f9z` |
| vestingReserve | `kQCrFDb2fJvx2bAT5puU3_IDZ01Je2k2FbOZ8HwC1o6wWAIx` |
| vestingStakingAllocation | `kQCN2u2GsvZhPsu53CkLTXRI0-Cb8fvWeOKVBwG8NQY6lXVg` |
...
**Legacy bootstrap flags** (pre IMP-PREMNT-03 fix):
...
Mainnet will use fresh bootstrap with post-PREMNT-03 authority wiring → **new code hashes and addresses**.

### Known limitations (no upgradeability)

- Contracts cannot be patched post-deploy; fixes require new deploy + migration plan.
- Testnet bytecode may predate Proposal cashback fix (IMP-GOVOTE-08) — mainnet uses fresh build.
- `FundEmissionReserve` must be called operationally before emission rewards accrue (IMP-PREMNT-04).
